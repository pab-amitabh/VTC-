  ...
  return (
    <section className="w-full bg-white py-8 md:py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 id="insurance-providers" className="text-3xl md:text-4xl font-bold text-[#181B1F] mb-6 text-center">
          ...
          <div className="md:w-2/3">
            <div className="relative">
              ...
              <img 
                ...
                className="w-full object-contain mx-auto h-auto max-h-[500px]"
