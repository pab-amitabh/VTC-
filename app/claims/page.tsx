      ...
      <div className="min-h-screen bg-white pt-20 pb-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-deepBlue mb-4">Insurance Claims</h1>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12 border border-gray-100">
            <div className="flex items-center mb-6">
              <AlertTriangle className="w-8 h-8 text-magenta mr-3" />
              <h2 className="text-2xl font-bold text-deepBlue">How to Report a Claim</h2>
            </div>
            
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg p-6 border-l-4 border-magenta shadow-sm">
                <div className="flex items-center mb-3">
                  <div className="bg-magenta text-white rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3">1</div>
                  <h3 className="text-lg font-semibold text-deepBlue">Emergency Call</h3>
                </div>
              ...
              <div className="bg-white rounded-lg p-6 border-l-4 border-magenta shadow-sm">
                <div className="flex items-center mb-3">
                  <div className="bg-magenta text-white rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3">2</div>
                  <h3 className="text-lg font-semibold text-deepBlue">Report Claim</h3>
                </div>
                <p className="text-gray-600">
              ...
              <div className="bg-white rounded-lg p-6 border-l-4 border-magenta shadow-sm">
                <div className="flex items-center mb-3">
                  <div className="bg-magenta text-white rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3">3</div>
                  <h3 className="text-lg font-semibold text-deepBlue">Submit Documents</h3>
                </div>
                <p className="text-gray-600">
            ...
            {insuranceCompanies.map((company, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div>
                    <div className="flex items-center mb-3">
                      <AlertTriangle className="w-5 h-5 text-magenta mr-2" />
                      <h4 className="text-lg font-semibold text-deepBlue">Emergency Assistance</h4>
                    </div>
                    <div className="bg-white rounded-lg p-3 border border-gray-100">
                      <p className="text-gray-600 whitespace-pre-line">{company.emergency}</p>
                    </div>
                  </div>
                  ...
                  {company.claims && (
                    <div>
                      <div className="flex items-center mb-3">
                        <Phone className="w-5 h-5 text-magenta mr-2" />
                        <h4 className="text-lg font-semibold text-deepBlue">Claim Assistance</h4>
                      </div>
                      <div className="bg-white rounded-lg p-3 border border-gray-100">
                        <p className="text-gray-600">{company.claims}</p>
                      </div>
                    </div>
                  )}
                  ...
                  <div>
                    <div className="flex items-center mb-3">
                      <Globe className="w-5 h-5 text-magenta mr-2" />
                      <h4 className="text-lg font-semibold text-deepBlue">Online Claim Submission</h4>
                    </div>
                    <div className="bg-white rounded-lg p-3 border border-gray-100">
                      <a 
                        ...
                        className="text-deepBlue hover:text-magenta font-medium hover:underline"
                      >
                        {company.website}
                      </a>
                      {company.submitUrl && (
                  ...
                  <div>
                    <div className="flex items-center mb-3">
                      <Mail className="w-5 h-5 text-magenta mr-2" />
                      <h4 className="text-lg font-semibold text-deepBlue">Mail Original Documents To</h4>
                    </div>
                    <div className="bg-white rounded-lg p-3 border border-gray-100">
          ...
          <div className="mt-12 bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <div className="flex items-start">
              <Clock className="w-6 h-6 text-magenta mr-3 mt-1 flex-shrink-0" />
              <div>
                <h3 className="text-lg font-semibold text-deepBlue mb-2">Important Reminder</h3>
                <p className="text-gray-600">
